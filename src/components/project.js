    ...
    if(this.props.project === 'project1'){
      return(
        <div style={projectsStyle}>
          ...
          <p><a href="https://github.com/mariajosetamayo/outdoor-sagas-app"><i className="fa fa-github fa-lg github" aria-hidden="true" style={githubLogoStyles}></i></a><a href="https://outdoor-sagas.herokuapp.com/"><i className="fa fa-link laptop" aria-hidden="true" style={websiteLinkStyles}></i></a></p>
      ...
      return(
        <div style={projectsStyle}>
          ...
          <p><a href="https://github.com/mariajosetamayo/foodTrack"><i className="fa fa-github fa-lg github" aria-hidden="true" style={githubLogoStyles}></i></a><a href="https://intense-badlands-10213.herokuapp.com/"><i className="fa fa-link laptop" aria-hidden="true" style={websiteLinkStyles}></i></a></p>
      ...
      return(
        <div style={projectsStyle}>
          ...
          <p><a href="https://github.com/mariajosetamayo/muncheck"><i className="fa fa-github fa-lg github" aria-hidden="true" style={githubLogoStyles}></i></a><a href="https://mariajosetamayo.github.io/muncheck/"><i className="fa fa-link laptop" aria-hidden="true" style={websiteLinkStyles}></i></a></p>
